...
import { fetchStaffAsync, updateStaffAsync, deleteStaffAsync } from 'src/features/admin/Redux/AdminAction';
...
// ----------------------------------------------------------------------
 ...
 export default function StaffMoreMenu({ username, initial }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
     ...
     const  data =  { 
      ...
      dispatch(updateStaffAsync(data));
      setisLoading(false);
      dispatch(fetchStaffAsync());
      handleClose();
  ...
  return (
    ...
    
    {
      ...
      >
        ...
        <MenuItem onClick={onDeleteStaff(staff.id)} sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
