...
import { fetchStudentAsync,updateStudentAsync,deleteStudentAsync } from "../Redux/AdminAction";
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((student) => {
                    ...
                    const { id,username,email,batch,first_name,last_name,user,avatarUrl} = student;
