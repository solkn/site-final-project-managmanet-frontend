...
// import assignCoordinatorReducer from '../Redux/assignCoordinator/reducer';
// import { assignCoordinator } from '../Redux/assignCoordinator/action';
...
//   const TABLE_HEAD = [
//     { id: 'user', label: 'ID', alignRight: false },
...
//                     .map((staff) => {
//                       const { username, email, first_name, last_name, user, avatarUrl } = staff;
//                       const isItemSelected = selected.indexOf(user);
...
//                             <UserMoreMenu username={username} initial="staff" />
//                           </TableCell>
//                         </TableRow>
//                       );
//                     })}
